        ...
        public Campaign doInBackground() throws Exception {
            ...
            if (getCampaignFile() == null) {
                ...
                if (proposal != null) {
                    ...
                    // 1. Finances & 2. Personnel & Units
                    // This is now handled entirely by the user using the standard AtB "Company Generator" dialog.
                    // The AI will hook into that dialog to generate lore-friendly pilot biographies upon generation.
